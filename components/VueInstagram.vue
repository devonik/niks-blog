...
onMounted(() => {
  ...
  if (!document.getElementById('vue-instagram-embed-script')) {
    injectScript()
  } else {
    validateUrl()
  }
...
<template>
  <!--The styles defined here are just for the placeholder while loading the iframe-->
  <blockquote
    ...
    <div style="padding: 16px">
      ...
      >
        <a
          ...
          "
          target="_blank"
          >A post shared by Nik (@nik.diver)</a
        >
      </p>
    </div>
  </blockquote>
